...
export const metadata: Metadata = {
  title: "Flex — the audit swarm",
  description:
    "One Solidity contract, three independent AI auditors, one reconciled report. When they agree it's confirmed; when one dissents, you know exactly where to look. Built on the BTL runtime.",
};
